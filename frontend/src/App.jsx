      ...
      {result && (
        <div className="search-result-groq">
          ...
          <div className="search-result-groq-header">
            ...
            <span className="search-result-groq-badge">AI Answer</span>
...
function FloatingChat() {
  ...
  const [messages, setMessages] = useState([
    { role: "assistant", content: "👋 Hello! I am your CS Tutor. Ask me anything about coding, algorithms, programming languages, or computer science!" }
  ]);
        ...
        <div className="chat-window">
          <div className="chat-header">
            <div className="chat-header-info">
              ...
              <div><div className="chat-header-name">CS Tutor</div><div className="chat-header-sub">⚡ AI Assistant</div></div>
            </div>
              ...
              {!result && !loading && (
                <div className="empty-state">
                  ...
                  <div className="empty-hints">
                    ...
                    <div className="hint-pill">⚡ Powered by AI</div>
                  </div>
                </div>
              )}
